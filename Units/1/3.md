## Custom List View Live Data Input Using Array Adapter.
...
class NumbersViewAdapter(context: Context, resources:Int, arrayList: List<Model>) : ArrayAdapter<Model?>(context, resources, arrayList as List<Model?>) {
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ad=NumbersViewAdapter(this,R.layout.custom_list_view,list)
        listView.adapter=ad
